...
var params = {};
params['version'] = "0.9.9.88 Wikivoyage Beta-dev"; //DEV: do not set this dynamically -- it is compared to the cookie "version" in order to show first-time info, and the cookie is updated in app.js
